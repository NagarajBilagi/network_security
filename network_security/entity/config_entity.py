...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.feature_store_path:str = os.path.join(self.data_ingestion_dir, training_pipeline.DATA_INGESTION_FEATURE_STORE_DIR, training_pipeline.FILE_NAME)
...
class ModelTrainerConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        self.model_trainer_dir = os.path.join(training_pipeline_config.artifact_dir, training_pipeline.MODEL_TRAINER_DIRECTORY_NAME)
        self.trained_model_file_path = os.path.join(self.model_trainer_dir, training_pipeline.MODEL_TRAINER_TRAINED_DIREACTORY, 
                                                    training_pipeline.MODEL_TRAINER_TRAINED_MODEL_NAME)
        self.expected_score = training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
        self.overfitting_underfitting_score =training_pipeline.MODEL_TRAINER_OVERFITTING_UNDERFITTING_THRESHOLD_SCORE